--[[
    Merchant.lua
    Vendor interactions: sell gray items, auto-repair gear
]]
        ...
        for slot = 1, C_Container.GetContainerNumSlots(bag) do
            ...
            if itemLink ~= nil then
                ...
                if itemID == nil then
                    ...
                    local currentItemValue = LA.PriceSources.GetItemValue(itemID, "VendorSell") or 0
                    ...
                    if rarity == 0 and currentItemValue ~= 0 then
                        ...
                        LA.Debug.Log("selling gray item: " .. itemLink .. " x" ..
                            iStackCount .. ": " .. GetCoinTextureString(currentItemValue))
