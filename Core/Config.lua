...
local generalOptionsGroup = {
    ...
    order = 25,
    name = "General",
    get = function(info) return LA.db.profile.general[info[#info]] end,
    set = function(info, value) LA.db.profile.general[info[#info]] = value; end,
    args = {
        generalFeaturesHeader = {
            order = 30,
            type = "header",
        ...
        ignoreRandomEnchants = {
            ...
            set = function(info, value)
                ...
                if oldValue ~= value then
                    LA:Print("Ignore random enchants: " ..
        ...
        surpressSessionStartDialog = {
            ...
            set = function(info, value)
                ...
                if oldValue ~= value then
                    ...
                    LA:Print("Changing Suppression status to: " ..
                                 tostring(value) .. ".")
                end
                -- LA.db.profile.general[info[#info]] = value;
                LA.db.profile.general.surpressSessionStartDialog =
                    surpressSessionStartDialogStatus
                LA:Print(
                    "Changing Suppression status to: " .. tostring(value) .. ".")
        ...
        autoStartLA = {
            type = "toggle",
            order = 55,
            name = "Auto-start without prompting",
            desc = "Enabling this will auto-start LootAppraiser Reloaded instead of prompting upon first loot.",
            width = "double",
            set = function(info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
                    LA:Print("Auto-start LootAppraiser Reloaded: " ..
                                 Config.FormatBoolean(value) .. ".")
                end
                LA.db.profile.general[info[#info]] = value;
            end
        ...
        ignoreSoulboundItems = {
            ...
            set = function(info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
                    LA:Print("Ignore soulbound items: " ..
                                 Config.FormatBoolean(value) .. ".")
                end
                LA.db.profile.general[info[#info]] = value;
            end
        ...
        sellGrayItemsToVendor = {
            type = "toggle",
            order = 62,
            name = "Auto Sell Gray Items",
            desc = "Auto sell gray items to vendor.",
            width = "double", -- added 9.24.2019
            set = function(info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
                    LA:Print("Auto Sell Gray Items: " ..
                                 Config.FormatBoolean(value) .. ".")
                end
                LA.db.profile.general[info[#info]] = value;
            end
        ...
        sellGrayItemsToVendorVerbose = {
            type = "toggle",
            order = 63,
            name = "Disable Verbose Auto Sell Gray Items Messages |cff00ff00NEW!|r",
            desc = "This will only display the total amount of gray items sold and not a per item message.",
            width = "double",
            set = function(info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
                    LA:Print(
                        "Disabling Verbose Auto Sell Gray Item Messages: " ..
                            Config.FormatBoolean(value) .. ".")
                end
                LA.db.profile.general[info[#info]] = value;
            end
        ...
        autoRepairGear = {
            ...
            desc = "Auto repair gear using your currency.",
            width = "double", -- added 9.24.2019
            set = function(info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
            ...
            validate = function(info, value)
                ...
                if not isValidPriceSource then
                    ...
                    DEFAULT_CHAT_FRAME:AddMessage(
                        "Invalid custom price source. See TSM documentation for detailed description.")
                    return false
                end
                return true
            end
        ...
        useDisenchantValue = {
            ...
            name = function()
                local name =
                    "Use disenchant value when looting bind-on-pickup (BoP) items."
                if not LA.TSM.IsTSMLoaded() then
                    name = name .. " (requires TSM)"
                end
                return name
            end,
            disabled = function() return not LA.TSM.IsTSMLoaded() end,
            get = function(info)
                return LA.db.profile.pricesource[info[#info]]
            end,
            set = function(info, value)
                local oldValue = LA.db.profile.pricesource[info[#info]]
                if oldValue ~= value then
                    LA:Print("Enable using disenchant value: " ..
                                 Config.FormatBoolean(value) .. ".")
                end
                LA.db.profile.pricesource[info[#info]] = value;
            end
        ...
        useSubClasses = {
            type = "toggle",
            order = 93,
            desc = "Enabling this will allow an item tab for setting price sources by item class.",
            width = "full",
            name = function()
                local name =
                    "Enable item class tab for multiple price sources. |cff00ff00NEW!|r"
                if not LA.TSM.IsTSMLoaded() then
                    name = name .. " (requires TSM)"
                end
                return name
            ...
            set = function(info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
                    LA:Print("Enabling item classes: " ..
                                 Config.FormatBoolean(value) .. ".")
                end
                LA.db.profile.general[info[#info]] = value;
            end
...
local tsmGroupsGroup = {
    ...
    order = 93,
    name = "TSM Groups",
    hidden = function() return not LA.TSM.IsTSMLoaded() end,
    -- name = "Sell Trash",
    get = function(info) return LA.db.profile.sellTrash[info[#info]] end,
    set = function(info, value) LA.db.profile.sellTrash[info[#info]] = value; end,
    args = {
        sellTrashOptions = {
            type = "group",
            order = 10,
            ...
            args = {
                ...
                tsmGroupEnabled = {
                    ...
                    set = function(info, value)
                        ...
                        if oldValue ~= value then
                            LA:Print("Sell trash via TSM group: " ..
                                         Config.FormatBoolean(value) .. ".")
                        end
                        LA.db.profile.sellTrash[info[#info]] = value;
                    end
            ...
            args = {
                ...
                addBlacklistedItems2DestroyTrash = {
                    ...
                    set = function(info, value)
                        ...
                        if oldValue ~= value then
                            LA:Print(
                                "Add blacklisted items to destroy trash: " ..
                                    Config.FormatBoolean(value) .. ".")
                        end
                        LA.db.profile.blacklist[info[#info]] = value;
                    end
                ...
                tsmGroupEnabled = {
                    ...
                    desc = "Use a TSM group to define blacklisted items. If deactivated LootAppraiser Reloaded uses the old unmaintained list.",
                    width = "full",
                    set = function(info, value)
                        local oldValue = LA.db.profile.blacklist[info[#info]]
                        if oldValue ~= value then
                            LA:Print("Blacklist items via TSM group: " ..
                                         Config.FormatBoolean(value) .. ".")
                        end
                        LA.db.profile.blacklist[info[#info]] = value;
                    end,
        ...
        general = {
            ...
            args = {
                ...
                notificationOptionsGrp = {
                    ...
                    args = {
                        ...
                        qualityFilter = {
                            ...
                            values = LA.CONST.QUALITY_FILTER,
                            set = function(info, value)
                                local oldValue =
                                    LA.db.profile.notification[info[#info]]
                                if oldValue ~= value then
                                    LA:Print(
                                        "Quality Filter set to: " ..
                                            LA.CONST.QUALITY_FILTER[value] ..
                                            " and above.")
                                end
                                LA.db.profile.notification[info[#info]] = value;
                                LA.UI.RefreshStatusText()
                            ...
                            disabled = function(info)
                                return not Config.SettingsChangeAllowed(
                                           info[#info])
                            end
                        },
                        ...
                        soundNameA = {
                            ...
                            disabled = function()
                                return not LA.db.profile.notification
                                           .playSoundEnabled
                            end
                        },
                        ...
                        goldAlertThresholdA = {
                            ...
                            set = function(info, value)
                                ...
                                if oldValue ~= value then
                                    LA:Print(
                                        "Gold alert threshold A set: " .. value ..
                                            "|cffffd100g|r or higher.")
                                    LA.Debug.Log(
                                        "change detected: " .. tostring(value))
                        ...
                        goldAlertThresholdB = {
                            ...
                            set = function(info, value)
                                ...
                                if oldValue ~= value then
                                    LA:Print(
                                        "Gold alert threshold B set: " .. value ..
                                            "|cffffd100g|r or higher.")
                                end
                                LA.db.profile.notification[info[#info]] = value;
                                LA.UI.RefreshStatusText()
                        ...
                        goldAlertThresholdC = {
                            ...
                            set = function(info, value)
                                ...
                                if oldValue ~= value then
                                    LA:Print(
                                        "Gold alert threshold C set: " .. value ..
                                            "|cffffd100g|r or higher.")
                                end
                                LA.db.profile.notification[info[#info]] = value;
                                LA.UI.RefreshStatusText()
                ...
                subClassOptions = {
                    type = "group",
                    order = 85,
                    name = "Item Classes", -- hidden = false,
                        ...
                        itemClassOptions = {
                            ...
                            args = {
                                ...
                                generalSubClassText = {
                                    ...
                                    order = 10,
                                    fontSize = "medium",
                                    name = "This section allows setting separate price sources based upon the Blizzard defined item classes.  Select the Item Class you want to enable and enter a valid price source. Tip:  If you are using TSM and want to know valid price sources, type:  /tsm sources and select from AuctionDB or External like TUJ.\n\n  [Examples:  vendorsell, dbminbuyout, dbmarketvalue, dbregionsaleavg, etc.]",
                                    width = "full"
                                },
                                ...
                                classTypeArmor = {
                                    ...
                                    order = 30,
                                    name = "Armor",
                                    desc = "Set a price source for Armor"
                                },
                                classTypeArmorPriceSource = {
                                    type = "input",
                                    order = 35,
                                    name = "Armor Price Source",
                                    desc = "Enter a valid TSM Price Source. See TSM documentation for detailed description.",
                                    width = "double",
                                    disabled = function()
                                ...
                                classTypeConsumable = {
                                    ...
                                    order = 40,
                                    name = "Consumable",
                                    desc = "Set a price source for Consumables (drinks, elixirs, flasks, foods, potions, scrolls, etc.)"
                                },
                                classTypeConsumablePriceSource = {
                                    type = "input",
                                    order = 45,
                                    name = "Consumable Price Source",
                                    desc = "Enter a valid TSM Price Source. See TSM documentation for detailed description.",
                                    width = "double",
                                    disabled = function()
                                        return not LA.db.profile
                                                   .classTypeConsumable
                                    end
                                },
                                ...
                                classTypeRecipe = {
                                    ...
                                    order = 45,
                                    name = "Recipe",
                                    desc = "Set a price source for Recipes covering all professions"
                                },
                                classTypeRecipePriceSource = {
                                    type = "input",
                                    order = 46,
                                    name = "Recipe Price Source",
                                    desc = "Enter a valid TSM Price Source. See TSM documentation for detailed description.",
                                    width = "double",
                                    disabled = function()
                                ...
                                classTypeTradeskill = {
                                    ...
                                    order = 50,
                                    name = "Tradeskill",
                                    desc = "Set a price source for Tradeskills (herbs, metal, stone, leather, cloth, etc.)"
                                },
                                classTypeTradeskillPriceSource = {
                                    type = "input",
                                    order = 55,
                                    name = "Tradeskill Price Source",
                                    desc = "Enter a valid TSM Price Source. See TSM documentation for detailed description.",
                                    width = "double",
                                    disabled = function()
                                        return not LA.db.profile
                                ...
                                classTypeWeapon = {
                                    ...
                                    order = 60,
                                    name = "Weapon",
                                    desc = "Set a price source for Weapons"
                                },
                                classTypeWeaponPriceSource = {
                                    type = "input",
                                    order = 65,
                                    name = "Weapon Price Source",
                                    desc = "Enter a valid TSM Price Source. See TSM documentation for detailed description.",
                                    width = "double",
                                    disabled = function()
                                ...
                                classTypeQuest = {
                                    ...
                                    order = 70,
                                    name = "Quest",
                                    desc = "Set a price source for sellable Quest items"
                                },
                                classTypeQuestPriceSource = {
                                    type = "input",
                                    order = 75,
                                    name = "Quest Price Source",
                                    desc = "Enter a valid TSM Price Source. See TSM documentation for detailed description.",
                                    width = "double",
                                    disabled = function()
                ...
                displayOptions = {
                    ...
                    args = {
                        displayMainUiOptions = {
                            ...
                            args = {
                                ...
                                showDetroyTrashBtn = {
                                    type = "toggle",
                                    order = 71,
                                    name = "Show 'Destroy Trash' button (/reload required)",
                                    desc = "Show 'Destroy Trash' button",
                                    width = "double"
                                },
                                showSellTrashBtn = {
                                    type = "toggle",
                                    order = 72,
                                    name = "Show 'Sell Trash' button (/reload required)",
                                    desc = "Show 'Sell Trash' button",
                                    width = "double"
                                },
                                showValueSoldToVendor = {
                                    type = "toggle",
                                    order = 73,
                                    name = "Show Gray Value Sold to Vendors",
                                ...
                                showResetInstanceButton = {
                                    type = "toggle",
                                    order = 80,
                                    name = "Show 'Reset Instance' Button (/reload required)",
                                    desc = "Show 'Reset Instance' Button",
                                    width = "double",
                                    set = function(info, value)
                                        LA.db.profile.display[info[#info]] =
                                            value
                                ...
                                descResetInstanceButton = {
                                    type = "description",
                                    order = 85,
                                    fontSize = "medium",
                                    name = "The displayed instance lockout should only help to optimize the 10 instance resets per hour. Not more and not less. No lockout magic, cross char tracking or such stuff.\n",
                                    width = "full"
                                },
                                ...
                                showLootedItemValueGroup = {
                                    type = "toggle",
                                    order = 110,
                                    name = "Show 'Group: Looted Item Value'",
                                    desc = "Show 'Group: Looted Item Value'",
                                    width = "double"
                                },
                                showLootedItemValueGroupPerHour = {
                                    type = "toggle",
                                    order = 120,
                                    name = "Show 'Group: Looted Item Value' Per Hour",
                                    desc = "Show 'Group: Looted Item Value' Per Hour (in parentes behind the Group: Looted Item Value)",
                                    width = "double"
                                },
                                addGroupDropsToLootedItemList = {
                                    type = "toggle",
                                    order = 130,
                                    name = "Add Group Drops to 'Looted Item List'",
                                    desc = "Add Group Drops to 'Looted Item List'",
                                    width = "double"
                                },
                                ...
                                showGroupLootAlerts = {
                                    type = "toggle",
                                    order = 132,
                                    name = "Opt-in Group/party loot alerts",
                                    desc = "Check to see group/party loot alerts",
                                    width = "double", -- added 9.24.2019
                                    set = function(info, value)
                                        local oldValue =
                                            LA.db.profile.display[info[#info]]
                        ...
                        displayLastNoteworthyItemOptions = {
                            type = "group",
                            order = 20,
                            name = "Additional LootAppraiser Reloaded 'Lite' windows",
                            hidden = false,
                            inline = true,
                            args = {
                                ...
                                enableLootAppraiserReloadedLite = {
                                    type = "toggle",
                                    order = 10,
                                    name = "Enable 'LootAppraiser Reloaded Lite' UI",
                                    desc = "Enables the 'LootAppraiser Reloaded Lite' UI which shows the looted item value.",
                                    width = "double"
                                },
                                enableLootAppraiserReloadedTimerUI = {
                                    type = "toggle",
                                    order = 10,
                        ...
                        displayMiscOptions = {
                            ...
                            args = {
                                enableTUJTooltip = {
                                    type = "toggle",
                                    order = 5,
                                    name = "Show TUJ prices in tooltip",
                                    width = "full",
                                    hidden = function()
                                        if not TUJTooltip then
                                            return true
                                        end
                                        return false
                                    end,
                ...
                aboutGroup = {
                    ...
                    args = {
                        ...
                        generalText21 = {
                            ...
                            order = 21,
                            fontSize = "medium",
                            name = "Berick (https://www.patreon.com/berick)",
                            width = "double"
                        },
                        blank22 = {
                            type = "description",
                        ...
                        generalText30 = {
                            ...
                            order = 30,
                            fontSize = "medium",
                            name = "\nFormer Creator/Author/Developer: ProfitzTV",
                            width = "full"
                        },
                        blank31 = {
                            type = "description",
                        ...
                        generalText41 = {
                            ...
                            order = 41,
                            fontSize = "medium",
                            name = "ProfitzTV (https://www.twitter.com/ProfitzTV)",
                            width = "double"
                        },
                        blank42 = {
                            type = "description",
                        ...
                        generalText51 = {
                            ...
                            order = 51,
                            fontSize = "medium",
                            name = "ProfitzTV (https://www.twitch.tv/ProfitzTV)",
                            width = "double"
                        },
                        blank52 = {
                            type = "description",
                        ...
                        generalText61 = {
                            ...
                            order = 61,
                            fontSize = "medium",
                            name = "ProfitzTV (https://www.youtube.com/ProfitzTV)",
                            width = "double"
                        },
                        blank62 = {
                            type = "description",
                        ...
                        generalText70 = {
                            ...
                            order = 70,
                            fontSize = "medium",
                            name = "\nFormer Co-Author/Developer: Testerle",
                            width = "full"
                        },
                        blank71 = {
                            type = "description",
                        ...
                        earlyAdoptersHeader = {
                            order = 81,
                            type = "header",
                            name = "Early Adopters/Beta Testers:"
                        },
                        generalText100 = {
                            type = "description",
                            order = 100,
                            fontSize = "medium",
                            name = "ACubed10, Brozerian, Conzec89, Goldgoblin, DozerBob, Fatherfajita, GoblinRaset, Hxtasy, JuniorDeBoss, Killerdamage, Morricade, PhatLewts, Selltacular, Skittlezz420, Soulslicer, Pellew",
                            width = "full"
                        }
                    }
                }
